...
CREATE TABLE etudiants (idEtudiant int(11) AUTO_INCREMENT NOT NULL,
...
CREATE TABLE epreuves (idEpreuve INT(11) NOT NULL,
...
CREATE TABLE enseignants (idEnseignant INT(11) NOT NULL,
...
CREATE TABLE faire_cours (idEnseignant INT(11) NOT NULL,
idMatiere INT(11) NOT NULL,
idFaireCours INT(11),
annee INT(11),
...
/*entree des etudiants*/

insert into etudiants values (1,'roblin','lea','12,bd de la liberte','calais',62100,'21-34-56-78','2014-09-01',1,'','F','1995-01-14');
...
insert into enseignants values (2,'pelletier','severine','CERTIFIE','213,avenue de londres','calais',62100,'21-54-87-61','1975-04-21','2014-09-01');
