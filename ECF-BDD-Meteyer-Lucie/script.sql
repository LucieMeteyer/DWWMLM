...
CREATE TABLE enseignants (idEnseignant int(11) AUTO_INCREMENT NOT NULL,
...
CREATE TABLE matieres (idMatiere int(11) AUTO_INCREMENT NOT NULL,
...
CREATE TABLE modules (idModule int(11) AUTO_INCREMENT NOT NULL,
nomModule VARCHAR(15),
coefficientModule INT(11),
PRIMARY KEY (idModule) ) ENGINE=InnoDB;

DROP TABLE IF EXISTS avoir_note ;
CREATE TABLE avoir_note (idAvoirNote int(11) AUTO_INCREMENT NOT NULL,
idEtudiant INT(11),
...
CREATE TABLE faire_cours (idFaireCours int(11) AUTO_INCREMENT NOT NULL,
idEnseignant INT(11),
idMatiere INT(11) NOT NULL,
annee INT(11),
...
ALTER TABLE faire_cours ADD CONSTRAINT FK_faire_cours_idEnseignant FOREIGN KEY (idEnseignant) REFERENCES enseignants (idEnseignant);
ALTER TABLE faire_cours ADD CONSTRAINT FK_faire_cours_idMatiere FOREIGN KEY (idMatiere) REFERENCES matieres (idMatiere);
>>>>>>> d821f9ea6054ceee298987dedb158b6f5da90aee
