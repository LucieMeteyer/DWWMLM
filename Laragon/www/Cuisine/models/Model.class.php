...
abstract class Model{ //connection a la bdd
    ...
    private static function setBdd(){
        self::$pdo = new PDO ("mysql:host=localhost;dbname=cuisine;charset=utf8","root","");//informations de connexion (chemin d'acces avec le nom,l'encodage, l'id et le pswd)
